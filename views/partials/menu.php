    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <!-- Bouton pour afficher la liste des fruits -->
                <li class="nav-item">
                    <a class="nav-link<?= ROUTE == '/fruits/liste/' ? ' active' : '' ?>" href="<?= PUBLIC_PATH ?>/fruits/liste/">Liste des fruits</a>
                </li>

                <!-- Bouton pour afficher le formulaire d'ajout de fruits -->
                <li class="nav-item">
                    <a class="nav-link<?= ROUTE == '/fruits/fiche/' ? ' active' : '' ?>" href="<?= PUBLIC_PATH ?>/fruits/fiche/">Ajouter un fruit</a>
                </li>
